...
\item
  It makes
  \href{https://www.lode.de/blog/comparing-word-and-latex}{beautiful}
  documents.
\item
...
\begin{frame}{Picture alignment/placement}
\protect\hypertarget{picture-alignmentplacement}{}
...
\begin{frame}{References and bibliography}
\protect\hypertarget{references-and-bibliography}{}
...
\item
  ...
  \textbackslash framebox\{\texttt{\textbackslash}
\item
...
\begin{varblock}{Exercise (Typesetting Text)}
...
\end{equation*} denote their mean. Then as \(n\) approaches infinity,
the random variables \(\sqrt{n}(S_n - \mu)\) converge in distribution to
a normal \(N(0, \sigma^2)\).
\end{quote}
